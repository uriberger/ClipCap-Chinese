...
with open(f'reformulation_experiment/data/infer/base_infer_on_additional_train_{exp_ind}_en_reformulated_coco', 'r') as fp:
...
with open(f'reformulation_experiment/data/image_ids/flickr_orig_to_new_image_id_{exp_ind}.json', 'r') as fp:
    flickr_orig_to_new_image_id = json.load(fp)
with open(f'reformulation_experiment/data/image_ids/coco_orig_to_new_image_id_{exp_ind}.json', 'r') as fp:
    coco_orig_to_new_image_id = json.load(fp)
