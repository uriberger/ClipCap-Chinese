...
echo "$MSG_PREFIX Base inference on XM3600"
venv/bin/python predict.py --image_ids_path crossmodal3600_zh.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_base/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/base_infer_on_xm3600_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp
...
echo "$MSG_PREFIX Translation inference on XM3600"
venv/bin/python predict.py --image_ids_path crossmodal3600_zh.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_translated/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/translated_infer_on_xm3600_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp

# Own captions based training
echo "$MSG_PREFIX Base inference on COCO"
venv/bin/python predict.py --image_ids_path ${BASE_DIR}/data/base_train_data/coco_image_ids_and_paths.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_base/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp
...
echo "$MSG_PREFIX Own inference on XM3600"
venv/bin/python predict.py --image_ids_path crossmodal3600_zh.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_own/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/own_infer_on_xm3600_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp
...
cd ../AliceMind/mPLUG
venv/bin/python reformulate.py --model_path output/vqa_mplug_base/checkpoint_07.pth --input_file ../../ClipCap-Chinese/${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}_en_translated.json --output_format caption --output_file ../../ClipCap-Chinese/${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}_en_reformulated --dataset COCO
cd ../../ClipCap-Chinese
...
echo "$MSG_PREFIX Reformulations inference on XM3600"
venv/bin/python predict.py --image_ids_path crossmodal3600_zh.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_reformulations/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/reformulations_infer_on_xm3600_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp
