...
#venv/bin/python process_flickr.py --clip_model_path ViT-B/32 --image_path /cs/labs/oabend/uriber/datasets/flickr30/images --caption_path ${BASE_DIR}/data/gt_train_data/gt_train_data_${EXP_IND}.txt --output_path ${BASE_DIR}/data/gt_train_data/preprocessed_data_${EXP_IND}.pkl
#echo "$MSG_PREFIX GT training"
#venv/bin/python train.py --data_path ${BASE_DIR}/data/gt_train_data/preprocessed_data_${EXP_IND}.pkl --gpt2_path pretrain_models/gpt2 --bert_path pretrain_models/bert --output_path ${BASE_DIR}/output/exp_${EXP_IND}_gt --lr 2e-5 --epochs 10 --prefix_len 10 --constant_len 10 --clip_size 512 --bs_train 40 --dev_size 100 --bs_eval 10 --max_len 100 --warmup_steps 5000 --eval_step 500 --finetune_gpt2 --mapping_type mlp --do_train --load_path ${BASE_DIR}/output/exp_${EXP_IND}_base/checkpoint-last.pt
#echo "$MSG_PREFIX GT inference"
#venv/bin/python predict.py --image_ids_path ${BASE_DIR}/data/image_ids/test_image_ids_${EXP_IND}.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_gt/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/gt_infer_on_test_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp

# Translation based training
echo "$MSG_PREFIX Prepare translated training data"
venv/bin/python ${BASE_DIR}/prepare_translation_training_data.py ${EXP_IND}
echo "$MSG_PREFIX Translation preprocess"
venv/bin/python process_flickr.py --clip_model_path ViT-B/32 --image_path /cs/labs/oabend/uriber/datasets/flickr30/images --caption_path ${BASE_DIR}/data/translated_train_data/translated_train_data_${EXP_IND}.txt --output_path ${BASE_DIR}/data/translated_train_data/preprocessed_data_${EXP_IND}.pkl
...
venv/bin/python predict.py --image_ids_path ${BASE_DIR}/data/image_ids/additional_train_image_ids_${EXP_IND}.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_base/checkpoint-last.pt --gpt2_model_path pretrain_models/gpt2 --bert_model_path pretrain_models/bert --clip_model_path ViT-B/32 --output_path ${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}.json --prefix_len 10 --constant_len 10 --clip_size 512 --max_len 100 --batch_size 4 --temperature 1 --topk 0 --topp 0.8 --num_generate 1 --finetune_gpt2 --mapping_type mlp
echo "$MSG_PREFIX Prepare own training data"
venv/bin/python ${BASE_DIR}/convert_to_training_data.py ${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}.json ${BASE_DIR}/data/own_train_data/own_train_data_${EXP_IND}.txt ${EXP_IND}
echo "$MSG_PREFIX Own preprocess"
venv/bin/python process_flickr.py --clip_model_path ViT-B/32 --image_path /cs/labs/oabend/uriber/datasets/flickr30/images --caption_path ${BASE_DIR}/data/own_train_data/own_train_data_${EXP_IND}.txt --output_path ${BASE_DIR}/data/own_train_data/preprocessed_data_${EXP_IND}.pkl
...
cd ../AliceMind/mPLUG
venv/bin/python reformulate.py --model_path output/vqa_mplug_base/checkpoint_07.pth --input_file ../../ClipCap-Chinese/${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}_en_translated.json --output_format caption --output_file ../../ClipCap-Chinese/${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}_en_reformulated --dataset flickr30k
cd ../../ClipCap-Chinese
...
venv/bin/python ${BASE_DIR}/convert_to_training_data.py ${BASE_DIR}/data/infer/base_infer_on_additional_train_${EXP_IND}_reformulated.json ${BASE_DIR}/data/reformulations_train_data/reformulations_train_data_${EXP_IND}.txt ${EXP_IND}
echo "$MSG_PREFIX Reformulations preprocess"
venv/bin/python process_flickr.py --clip_model_path ViT-B/32 --image_path /cs/labs/oabend/uriber/datasets/flickr30/images --caption_path ${BASE_DIR}/data/reformulations_train_data/reformulations_train_data_${EXP_IND}.txt --output_path ${BASE_DIR}/data/reformulations_train_data/preprocessed_data_${EXP_IND}.pkl
...
venv/bin/python ${BASE_DIR}/convert_to_training_data.py ${BASE_DIR}/data/translated_data/flickr30k_mplug_re_zh_translated_helsinki.json ${BASE_DIR}/data/translated_train_data/mplug_re_train_data_${EXP_IND}.txt ${EXP_IND}
